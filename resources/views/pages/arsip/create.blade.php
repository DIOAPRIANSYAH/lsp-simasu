    ...
    <div class="p-6 overflow-hidden dark:bg-dark-eval-1">
        <div class="container mx-auto py-8">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Tambah Arsip</h1>
            </div>
            ...
            <div class="p-6 overflow-hidden dark:bg-dark-eval-1">
                <form action="{{ route('arsip.store') }}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="no_surat" id="no_surat" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300" value="{{ old('no_surat') }}" required>
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="judul" id="judul" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300" value="{{ old('judul') }}" required>
                    </div>

                    <div class="mb-4">
                        <label for="file_surat" class="block text-sm font-medium text-gray-700 dark:text-gray-300">File Surat (PDF)</label>
                        <input type="file" name="file_surat" id="file_surat" accept=".pdf" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300" required>
                    </div>
