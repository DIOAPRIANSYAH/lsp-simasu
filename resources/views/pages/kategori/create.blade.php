    ...
    <div class="p-6 overflow-hidden  dark:bg-dark-eval-1">
        <div class="container mx-auto py-8">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Tambah Kategori</h1>
            </div>
            ...
            <div class="p-6 overflow-hidden  dark:bg-dark-eval-1">
                <form action="{{ route('kategori.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama" id="nama" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300" value="{{ old('nama') }}" required>
                    </div>
                    <div class="mb-4">
                        <label for="keterangan" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Keterangan</label>
                        <textarea name="keterangan" id="keterangan" rows="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300" required>{{ old('keterangan') }}</textarea>
                    </div>
